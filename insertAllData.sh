...
#
loopDataFile = ARGV[0]
doJustLoopDataFile = ARGV[1]

# get the client
client = Riak::Client.new(:pb_port => 8087)

if doJustLoopDataFile != "t"
  ...
  station_rows.each do |row|
    ...
    puts "inserted station #" + num_inserted.to_s + ": " + station_data.to_s
...
CSV.foreach(ARGV[0]) do |row|
  ...
  puts "inserted loopdata #" + num_inserted.to_s + ": " + loopdata_data.to_s
end
puts "Done. " + num_inserted.to_s + " k/v pairs inserted."
puts "Finished."
